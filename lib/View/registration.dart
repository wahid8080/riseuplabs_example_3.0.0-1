...
import 'package:emp/View/login_page.dart';
              ...
              child: Column(
                ...
                children: [
                  const Padding(
                    ...
                    child: Text('Create an account!',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 20),),
                  ),
                  ...
                  Align(
                    ...
                    child: InkWell(
                      ...
                      child: const Padding(
                        ...
                        child: Text('You have an account?',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,decoration: TextDecoration.underline,), ),
                      ),
                    ),
                  )
                ],
                ...
                onTap: (){
                  ...
                  if(passwordController.text==confirmPasswordController.text){
                    if(userNameController.text.isNotEmpty||passwordController.text.isNotEmpty){
                      ...
                      ApiController().postRequest(endPoint: ApiEndPoints().createAccount,body: body).then((value){
                        if(value.responseCode==201){
                          ShowToast.myToast("Successfully Sign up", Colors.black, 2);
                          Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) => LoginPage()), (Route<dynamic> route) => false);
                          setState((){
                            isWorking = false;
                          });
                    ...
                    ShowToast.myToast("Password doesn't match", Colors.black, 2);
                  }
                },
                child: Container(
                  alignment: Alignment.center,
                  ...
                  child: AnimatedCrossFade(
                    firstChild: const Text('Sign up',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold)),
